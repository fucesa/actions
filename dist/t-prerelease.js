...
var run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var releaseBranch, branch, appVersion, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                releaseBranch = core.getInput("release-branch");
                return [4 /*yield*/, exec("git rev-parse --abbrev-ref HEAD")];
            case 1:
                branch = _a.sent();
                console.log("Release branch set to: ", releaseBranch);
                appVersion = "";
                if (!(branch === releaseBranch)) return [3 /*break*/, 2];
                appVersion = version;
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, exec("git rev-parse --short HEAD")];
            case 3:
                appVersion = _a.sent();
                _a.label = 4;
            case 4:
            ...
            case 5:
                error_1 = _a.sent();
                core.setFailed("Debug-action failure: " + error_1);
                return [3 /*break*/, 6];
