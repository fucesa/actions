...
var expand = __webpack_require__(815);
var homedir = __webpack_require__(615);
...
function tryNpmPath() {
  try {
    return fs.realpathSync(__webpack_require__(814).sync('npm'));
  } catch (err) {}
  return null;
}
...
var resolveDir = __webpack_require__(581);
var detect = __webpack_require__(415);
...
var path = __webpack_require__(622);
var expand = __webpack_require__(815);
var gm = __webpack_require__(621);
...
/* harmony import */ var findup_sync__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
...
var packageJson = __webpack_require__(875)(findup_sync__WEBPACK_IMPORTED_MODULE_2__("package.json"));
const { version } = __webpack_require__(875)(packageJson);
...
const run = async () => {
    try {
        const releaseBranch = _actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput("release-branch");
        ...
        _actions_core__WEBPACK_IMPORTED_MODULE_1__.setOutput("app-version", appVersion);
        _actions_core__WEBPACK_IMPORTED_MODULE_1__.setOutput("branch", branch);
    }
    catch (error) {
        _actions_core__WEBPACK_IMPORTED_MODULE_1__.setFailed(`Debug-action failure: ${error}`);
    }
};
run();
/* harmony default export */ __webpack_exports__["default"] = (run);
//# sourceMappingURL=data:application/json;base64,
